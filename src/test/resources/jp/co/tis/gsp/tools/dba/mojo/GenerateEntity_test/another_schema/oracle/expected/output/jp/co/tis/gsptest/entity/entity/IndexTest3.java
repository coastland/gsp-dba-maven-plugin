...
@Generated("GSP")
@Entity
@Table(schema = "GSPANOTHER", name = "INDEX_TEST3")
public class IndexTest3 implements Serializable {
     ...
     */
    @Id
    @GeneratedValue(generator = "GSPANOTHER.INDEX_TEST3_ID_SEQ", strategy = GenerationType.AUTO)
    @SequenceGenerator(name = "GSPANOTHER.INDEX_TEST3_ID_SEQ", sequenceName = "GSPANOTHER.INDEX_TEST3_ID_SEQ", initialValue = 1, allocationSize = 1)
