...
public class Typetest implements Serializable {
     ...
     * @return TYPE2
     */
    @Column(name = "TYPE2", length = 100, nullable = true, unique = false)
     ...
     * @return TYPE3
     */
    @Column(name = "TYPE3", length = 10, nullable = true, unique = false)
     ...
     * @return TYPE4
     */
    @Column(name = "TYPE4", length = 100, nullable = true, unique = false)
     ...
     */
    @Lob
    @Column(name = "TYPE6", length = 200, nullable = true, unique = false)
     ...
     * @return TYPE7
     */
    @Column(name = "TYPE7", precision = 10, nullable = true, unique = false)
     ...
     * @return TYPE8
     */
    @Column(name = "TYPE8", precision = 53, nullable = true, unique = false)
     ...
     * @return TYPE9
     */
    @Column(name = "TYPE9", precision = 53, nullable = true, unique = false)
     ...
     * @return TYPE10
     */
    @Column(name = "TYPE10", length = 200, nullable = true, unique = false)
     ...
     * @return TYPE11
     */
    @Column(name = "TYPE11", precision = 10, nullable = true, unique = false)
     ...
     * @return TYPE12
     */
    @Column(name = "TYPE12", length = 32700, nullable = true, unique = false)
     ...
     * @return TYPE13
     */
    @Column(name = "TYPE13", length = 32700, nullable = true, unique = false)
     ...
     * @return TYPE14
     */
    @Column(name = "TYPE14", precision = 10, nullable = true, unique = false)
     ...
     * @return TYPE15
     */
    @Column(name = "TYPE15", precision = 24, nullable = true, unique = false)
     ...
     * @return TYPE16
     */
    @Column(name = "TYPE16", precision = 5, nullable = true, unique = false)
     ...
     * @param type17 TYPE17
     */
    public void setType17(Time type17) {
        this.type17 = type17;
    }
    /**
     * TYPE18を返します。
     ...
     * @param type18 TYPE18
     */
    public void setType18(Date type18) {
        this.type18 = type18;
    }
    /**
     * TYPE19を返します。
     ...
     * @return TYPE19
     */
    @Column(name = "TYPE19", length = 100, nullable = true, unique = false)
     ...
     * @return TYPE20
     */
    @Column(name = "TYPE20", length = 200, nullable = true, unique = false)
     ...
     * @return TYPE21
     */
    @Column(name = "TYPE21", length = 1, nullable = true, unique = false)
