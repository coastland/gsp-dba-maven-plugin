...
* [JPA simple verification](#jpa-simple-verification)
    * A verification with simple JPA (Hibernate) using the entities generated by integration-test.
    * Strictly speaking, this validation is done with Jakarta Persistence after Jakarta EE was transferred, but for the sake of convenience, we refer to it as JPA here.
